...
const NEW_MANAGER = ENV === 'devnet' 
  ? new anchor.web3.PublicKey("HMcuvAp4dB1EePEBcQHVAprVxpqWaJKBviJgGa8k3ZFF") // devnet report bot
  : new anchor.web3.PublicKey("JE1GQhjSiam5TckzWcUu6CHERM3ELfmsVcfd6VJvj6wv"); // mainnet report bot
